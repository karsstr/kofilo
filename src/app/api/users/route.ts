...
// GET: List semua kasir | POST: Tambah kasir | DELETE: Hapus kasir
  ...
  try {
    ...
    const user = await prisma.user.create({
      data: {
        ...
        role: "CASHIER", // akun yang dibuat admin selalu CASHIER
      },
...
// ─── DELETE: Hapus kasir berdasarkan ID ───────────────────────
export async function DELETE(req: NextRequest) {
  ...
  try {
    ...
    // Pastikan target adalah CASHIER (tidak bisa hapus SUPER_ADMIN)
