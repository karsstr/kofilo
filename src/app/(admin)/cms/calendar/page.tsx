...
export default function CalendarPage() {
  ...
  // Hitung max revenue untuk chart bar scaling
            ...
            {(monthlyReport?.data || []).map((d) => {
              ...
              return (
                <button
                  ...
                  className={`relative p-5 rounded-2xl border-2 text-left transition-all duration-200 hover:-translate-y-1 hover:shadow-lg group ${
                    isCurrentMonth ? "border-[#6C4E31] bg-[#6C4E31]/5" : "border-gray-100 hover:border-[#6C4E31]/30 bg-white"
                  }`}
                >
