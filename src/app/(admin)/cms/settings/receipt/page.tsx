...
export default function ReceiptSettingsPage() {
  ...
  // Ambil juga storeName untuk keperluan Preview Struk
  ...
  // Format tanggal hari ini untuk struk simulasi
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          <form onSubmit={handleSubmit} className="bg-white border border-gray-100 rounded-[24px] p-8 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.04)]">
            ...
            <div className="space-y-6">
              ...
              {/* WiFi Password */}
              <div className="space-y-2">
                <label className="block text-[12px] font-extrabold text-gray-400 uppercase tracking-widest">Password WiFi (Opsional)</label>
                <div className="relative">
                  ...
                  <input type="text" value={formData.wifiPassword} onChange={(e) => setFormData({ ...formData, wifiPassword: e.target.value })}
                    ...
                    placeholder="kofiloguest2026" />
                </div>
                <p className="text-[11px] text-gray-400 font-medium">Otomatis mencetak informasi WiFi di struk jika diisi.</p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] relative">
              ...
              <div className="font-mono text-[13px] text-gray-800 flex flex-col gap-3 pt-2">
                ...
                {formData.wifiPassword && (
                  <div className="text-center text-[12px] bg-gray-100/50 py-2 rounded">
                    <span className="font-bold">Wi-Fi:</span> Kofilo_Guest<br/>
                    <span className="font-bold">Pass:</span> {formData.wifiPassword}
                  </div>
                )}

                {/* Footer Message */}
                <div className="text-center mt-2 text-[12px] whitespace-pre-wrap">
              ...
              {/* Efek gerigi bawah */}
              <div className="absolute bottom-0 left-0 right-0 h-2 bg-repeat-x bg-[length:10px_10px]" style={{ backgroundImage: 'radial-gradient(circle at 5px 10px, transparent 5px, white 6px)', transform: 'rotate(180deg)' }}></div>
            </div>
